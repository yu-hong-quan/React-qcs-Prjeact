...
class VacuumCup extends Component{
	render(){
		return(
			<div>
				<div style={{'marginBottom':'3px'}}>
					<img src={this.props.VacuumCupOne.image} alt=""/>
				</div>
				<div className="SalesList">
					<ul>
						{
							this.props.VacuumCupData.map((item,index)=><li key={item+index}>
								<div>
